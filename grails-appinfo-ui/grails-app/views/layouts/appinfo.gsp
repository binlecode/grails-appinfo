...
<head>
    ...
    <asset:stylesheet href="appinfo/AdminLTE.css"></asset:stylesheet>
    <asset:javascript src="appinfo/plugins/jQuery/jQuery-2.1.4.min.js"></asset:javascript>
    <asset:javascript src="appinfo/plugins/datatables/jquery.dataTables.js"></asset:javascript>
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="${actionName == 'index' ? 'active' : ''}">
                    <g:link controller="appinfoDashboard" action="index">
                        <i class="fa fa-dashboard"></i> <span>Dashboard</span>
                    </g:link>
                </li>
                <li class="${actionName == 'traceInfo' ? 'active' : ''}">
                    <g:link controller="appinfoDashboard" action="traceInfo">
                        <i class="fa fa-tasks"></i> <span>Traceability</span>
                        <span class="label label-primary pull-right">HTTP</span>
                    </g:link>
                </li>
                <li class="${actionName == 'beanInfo' ? 'active' : ''}">
                    <g:link controller="appinfoDashboard" action="beanInfo">
                        <i class="fa fa-cubes"></i> <span>Beans</span>
                    </g:link>
                </li>
                <li class="${actionName == 'allMappings' ? 'active' : ''}">
                    <g:link controller="appinfoDashboard" action="mappingInfo">
...
<asset:javascript src="appinfo/app.js"></asset:javascript>
</body>
</html>
